@props(['id' => null,'historyPage'=>false, 'changepage'=>false ,'order' => null, "coordinatorOrders" =>null, "coordinatorHistory"=>false])
...
@elseif($coordinatorHistory)
    <tr id="{{$order->id}}">
        ...
        <td class="border border-gray-700 p-2">
            <p class="w-full border-0 my-3">{{$order->event_date}}</p>
            {{-- <input name="orders[0][event_date]" type="text" id="input0" class="w-full border-0 " value="{{$order->event_date}}" readonly/> --}}
        </td>
